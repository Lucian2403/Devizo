...
export const companySettingsSchema = z.object({
  ...
  paymentTerms: z.string().trim().max(1200).optional(),
  executionDuration: z.string().trim().max(400).optional(),
  inclusions: z.string().trim().max(1200).optional(),
  exclusions: z.string().trim().max(1200).optional(),
  legalTerms: z.string().trim().max(2400).optional(),
