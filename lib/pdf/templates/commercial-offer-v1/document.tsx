// Frozen commercial PDF layout: commercial-offer-v1.
// Do not edit this file for redesigns; add a new versioned template instead.
...
function QuoteDocument({
  ...
  const docNumber = version.documentNumber ?? "—";
 ...
 */
export async function renderCommercialOfferV1(
  version: QuoteVersion,
): Promise<Buffer> {
  ensureFonts();
